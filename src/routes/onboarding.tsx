...
import { OnboardingRail, type OnboardingStepInfo } from '@/components/onboarding/onboarding-rail'
...
const RAIL_STEPS: OnboardingStepInfo[] = [
  { key: 'account', title: 'Account created', description: 'Your login and profile are set.' },
  { key: 'hotel', title: 'Hotel configured', description: 'Room types, capacity, and currency.' },
  { key: 'invite', title: 'Invite your staff', description: 'Add managers, front desk, and more.' },
  { key: 'live', title: "You're live", description: 'Start managing rooms and operations.' },
]

const RAIL_COPY: Record<'hotel' | 'invite' | 'live', { headline: string; description: string }> = {
  hotel: {
...
function OnboardingPage() {
  ...
  return (
    <div className="flex h-svh overflow-hidden">
      <OnboardingRail steps={RAIL_STEPS} activeKey={step} {...RAIL_COPY[step]} />
